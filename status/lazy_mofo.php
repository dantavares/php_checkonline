...
// version 2020-12-21 - Customizado

class lazy_mofo{

    public $dbh = false;                    // required, pass the PDO connection object into the constructor
    public $top_table = true;               // enable / disable top table for add / search and export link
    ...
    // output date formats
    public $date_out = 'd/m/Y';                 // output date, change to d/m/Y for non-us
